...
export const ProductGrid: React.FC<ProductGridProps> = ({
  ...
  return (
    <main className="bg-gray-light">
      ...
      <section id="catalog" className="max-w-screen-xl m-auto py-10 grid grid-cols-12 gap-6" aria-label={`Каталог ${title.toLowerCase()}`}>
        {/* Sidebar */}
        ...
        <ProductsLoadingState loading={loading} error={error}>
          <div className="col-span-12 md:col-span-9 order-1 md:order-2">
            ...
            {filtered.length === 0 && !loading && !error ? (
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6" role="list" aria-label={`Список ${title.toLowerCase()}`}>
