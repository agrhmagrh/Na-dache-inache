        ...
        <aside className="hidden md:block col-span-3">
          <div className="bg-white border border-gray-additional rounded p-4 sticky top-4">
            ...
            <div className="text-sm text-gray-500">
              Используйте фильтры на странице каталога
            </div>
            <Link href="/pergols" className="mt-3 inline-block text-orange">
              Вернуться в каталог
            </Link>
          </div>
        </aside>
            ...
            <div className="col-span-12 lg:col-span-5">
              <div className="bg-white rounded p-5 border border-gray-additional">
                ...
                <div className="space-y-1.5 text-sm mb-4">
                  <div>
                    <span className="text-gray-additional">
                      Внешние размеры:
                    </span>{" "}
                ...
                <div className="text-sm text-gray-additional">
                  Цена за комплект
                </div>
                ...
                <div className="grid grid-cols-2 gap-3 mt-3">
                  <button className="bg-orange text-white py-2 font-semibold">
                    Заказать
                  </button>
                  <button className="bg-gray-dark text-white py-2 font-semibold">
                    Консультация
                  </button>
                </div>
