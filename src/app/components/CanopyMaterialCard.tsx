...
import { type CanopyMaterial } from "@/app/contstants/canopies";

interface CanopyMaterialCardProps extends Omit<CanopyMaterial, 'id'> {}

export default function CanopyMaterialCard({ name, description, image, imageAlt }: CanopyMaterialCardProps) {
  return (
